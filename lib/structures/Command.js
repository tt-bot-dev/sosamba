...
class Command extends Base {
     ...
     * @property {string} [args] The fallback argument string if the details cannot be gathered from the parser.
     * @property {ArgumentParser} [argParser] The argument parser.
     * @property {boolean} [displayInHelp=true] Whether to display this command in the default help command or not.
     * @property {string} [description] The command's description for the default help command.
     */
    ...
    constructor(sosamba, fileName, filePath, {name, args, argParser, displayInHelp, description}) {
        ...
        /**
         * The command description for the default help command.
         * @type {string}
         */
     ...
     * @returns {boolean} Whether the command should run - false to stop the command from running, true to run the command.
     */
    ...
    /**
     * Run a command
     * @param {Sosamba.Context} ctx The command context
