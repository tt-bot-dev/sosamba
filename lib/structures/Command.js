...
class Command extends Base {
    constructor(sosamba, fileName, filePath, { name, args, argParser, displayInHelp, description, aliases }) {
        ...
        this.aliases = [];
        if (aliases && Array.isArray(aliases)) this.aliases = aliases.filter(o => typeof o === "string");
