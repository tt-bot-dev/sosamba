...
class SosambaClient extends Client {
     ...
     * @memberof Sosamba.SosambaClient
     * @extends {external:ClientOptions}
     * @property {Sosamba.SosambaClient.LoggingOptions} log The logging options
     */
     ...
     * @param {Sosamba.SosambaClient.SosambaClientOptions} options The options of the client
     ...
     * @event Sosamba.SosambaClient#sosambaEventError
     ...
     * @event Sosamba.SosambaClient#sosambaCommandError
