...
class SimpleArgumentParser extends ArgumentParser {
     ...
     * @memberof SimpleArgumentParser
     * @property {boolean} filterEmptyArguments Whether to filter empty arguments. When the quoted parsing is used, this is always true
     * @property {boolean} allowQuotedString Whether to use quoted parsing or not
