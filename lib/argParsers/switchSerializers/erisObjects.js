 ...
 * @returns {T}
 */
const constructQuery = (ctx, collection, predicate, itemName, displayAs) => new Promise((rs, rj) => {
...
Here are the options:`,
                ...
                color: Colors.WARN,
                footer: {
                    text: `This menu automatically times out after 5 minutes. | Sosamba v${version}`
                }
            }
        }).then(m => {
